        ...
        forms: [
          {
            ...
            fields: [],
            consentCheckboxes: [{ label: "Send me marketing emails", preChecked: true, purposeBundled: false }],
          },
        ],
      }),
    ]);
        ...
        forms: [
          {
            ...
            actionIsThirdParty: false,
            fields: [],
            consentCheckboxes: [{ label: "I accept the terms", preChecked: true, purposeBundled: false }],
          },
        ],
      }),
    ]);
